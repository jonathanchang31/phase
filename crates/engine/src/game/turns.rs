        ...
        match state.phase {
            ...
            Phase::PreCombatMain | Phase::PostCombatMain => {
                ...
                if state.phase == Phase::PreCombatMain {
                    ...
                    // CR 703.4g: If the active player controls Attractions,
                    // they roll to visit them as the precombat-main turn-based action.
                    super::effects::attraction::perform_precombat_main_visit(state, events);
